...
class seasonControl(object):
    ...
    def __init__(self, parent, app, parent_sizer):
        ...
        # Add to sizers
        self.s_seasons_flex.Add(self.seasons_select_summer_im, 0, wx.ALIGN_LEFT|wx.RIGHT|wx.LEFT|wx.BOTTOM, 2)
        self.s_seasons_flex.Add(self.seasons_select_summer, 0, wx.ALIGN_LEFT|wx.RIGHT|wx.BOTTOM, 2)
        self.s_seasons_flex.Add(self.seasons_select_winter_im, 0, wx.ALIGN_LEFT|wx.RIGHT|wx.LEFT|wx.BOTTOM, 2)
        self.s_seasons_flex.Add(self.seasons_select_winter, 0, wx.ALIGN_LEFT|wx.RIGHT|wx.BOTTOM, 2)
        ...
        self.sizer.Add(self.s_seasons_flex, 0, wx.TOP|wx.BOTTOM, 2)
