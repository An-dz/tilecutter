...
#  Image Dimensions Control Panel
...
class controlDims(wx.Panel):
    ...
    def __init__(self, parent, app):
        debug("tcui.controlDims: __init__")
        ...
        self.dims_x_select = wx.ComboBox(  self, wx.ID_ANY, "", (-1, -1), (-1, -1), style=wx.CB_READONLY)
        self.dims_y_label  = wx.StaticText(self, wx.ID_ANY, "", (-1, -1), (-1, -1))
        self.dims_y_select = wx.ComboBox(  self, wx.ID_ANY, "", (-1, -1), (-1, -1), style=wx.CB_READONLY)
    ...
    def translate(self):
        ...
        debug("tcui.controlDims: translate")

        self.label.SetLabel(gt("Dimensions:"))
        self.dims_p_label.SetLabel(gt("Paksize"))
        self.dims_p_select.SetToolTip(gt("tt_dims_paksize_select"))
        self.dims_z_label.SetLabel(gt("Z dimension"))
        self.dims_z_select.SetToolTip(gt("tt_dims_z_select"))
        self.dims_x_label.SetLabel(gt("X dimension"))
        self.dims_x_select.SetToolTip(gt("tt_dims_x_select"))
        self.dims_y_label.SetLabel(gt("Y dimension"))
        self.dims_y_select.SetToolTip(gt("tt_dims_y_select"))

        # To allow for translation of values in combobox controls,
        # master list is int list, translated list is generated
        # on the fly from the master list, these lists then index
        ...
        self.dims_y_select.Append(self.choicelist_dims)
        # And set value to value in the project
    ...
    def OnPaksizeSelect(self, e):
        ...
        debug("tcui.controlDims: OnPaksizeSelect")
    ...
    def OnZdimsSelect(self, e):
        ...
        debug("tcui.controlDims: OnZdimsSelect")
    ...
    def OnXdimsSelect(self, e):
        ...
        debug("tcui.controlDims: OnXdimsSelect")
    ...
    def OnYdimsSelect(self, e):
        ...
        debug("tcui.controlDims: OnYdimsSelect")
