...
class offsetControl(wx.StaticBox):
    ...
    def __init__(self, parent, app, parent_sizer):
        ...
        self.offset_button_up_left = wx.BitmapButton(parent, wx.ID_ANY, imres.catalog["MoveUpAndLeftDouble"].getBitmap(), (-1,-1), (18,18))
        self.offset_button_up_right = wx.BitmapButton(parent, wx.ID_ANY, imres.catalog["MoveUpAndRightDouble"].getBitmap(), (-1,-1), (18,18))
        self.offset_button_down_left = wx.BitmapButton(parent, wx.ID_ANY, imres.catalog["MoveDownAndLeftDouble"].getBitmap(), (-1,-1), (18,18))
        self.offset_button_down_right = wx.BitmapButton(parent, wx.ID_ANY, imres.catalog["MoveDownAndRightDouble"].getBitmap(), (-1,-1), (18,18))
