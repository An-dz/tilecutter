...
class offsetControl(wx.Panel):
    ...
    def __init__(self, parent, app):
        """"""
        debug("tcui.OffsetControl: __init__")
    ...
    def translate(self):
        ...
        debug("tcui.OffsetControl: translate")
    ...
    def update(self):
        ...
        debug("tcui.OffsetControl: update")
    ...
    def OnFine(self,e):
        ...
        debug("tcui.OffsetControl: OnFine")
    ...
    def OnUpLeft(self,e):
        ...
        debug("tcui.OffsetControl: OnUpLeft")
        if self.offset_selector.GetValue():
    ...
    def OnUpRight(self,e):
        ...
        debug("tcui.OffsetControl: OnUpRight")
        if self.offset_selector.GetValue():
    ...
    def OnDownLeft(self,e):
        ...
        debug("tcui.OffsetControl: OnDownLeft")
        if self.offset_selector.GetValue():
            self.app.activeproject.active_offset([max(self.app.activeproject.active_x_offset() - 2, 0), 
    ...
    def OnDownRight(self,e):
        ...
        debug("tcui.OffsetControl: OnDownRight")
        if self.offset_selector.GetValue():
            self.app.activeproject.active_offset([self.app.activeproject.active_x_offset() + 2, 
                                                  max(self.app.activeproject.active_y_offset() - 1, 0)])
        else:
    ...
    def OnLeft(self,e):
        """Move mask left"""
        debug("tcui.OffsetControl: OnLeft")
        if self.offset_selector.GetValue():
    ...
    def OnCenter(self,e):
        """Reset mask position"""
        debug("tcui.OffsetControl: OnCenter")
        self.app.activeproject.active_offset([0,0])
    def OnRight(self,e):
        """Move mask right"""
        debug("tcui.OffsetControl: OnRight")
        if self.offset_selector.GetValue():
    ...
    def OnDown(self,e):
        """Move mask down"""
        debug("tcui.OffsetControl: OnDown")
        if self.offset_selector.GetValue():
